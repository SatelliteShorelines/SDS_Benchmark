...
filepath = os.path.join(os.getcwd(),'examples','NARRA_tides_full.csv')
...
for key in cross_distance.keys():
    ...
    # save plot
    fig.savefig(os.path.join(fp,'comparison_transect_%s.jpg'%key), dpi=150)
...
fig.savefig(os.path.join(fp,'comparison_all_transects.jpg'), dpi=150)